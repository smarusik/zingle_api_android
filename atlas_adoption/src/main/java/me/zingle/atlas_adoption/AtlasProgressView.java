...
public class AtlasProgressView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int defaultWidth =  (int) ViewUtils.getPxFromDp(getDefaultWidthDp(), getContext());
        int defaultHeight = (int) ViewUtils.getPxFromDp(getDefaultHeightDp(), getContext());
        ...
        if (debug) Log.w(TAG, "onMeasure() before: " + mWidthBefore + "x" + mHeightBefore
                + ", spec: " + ViewUtils.toStringSpec(widthMeasureSpec) + "x" + ViewUtils.toStringSpec(heightMeasureSpec)
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float innerRadiusPx = ViewUtils.getPxFromDp(pieRadiusDp, getContext());
        ...
        float ringInnerRadiusPx = innerRadiusPx + ViewUtils.getPxFromDp(spacingWidthDp, getContext());
