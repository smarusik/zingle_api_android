...
public class ZingleUIInitAndStart {
    ...
    public static abstract class ConversationAdding<ViewType> extends AsyncTask<String,String,Boolean> {

        final String serviceId;
        final String contactId;
        final String contactChannelValue;

        protected ViewType viewForUpdate=null;

        public ConversationAdding(String serviceId, String contactId, String contactChannelValue) {
            this.serviceId = serviceId;
            this.contactId = contactId;
            this.contactChannelValue = contactChannelValue;
        }

        public ConversationAdding(String serviceId, String contactId, String contactChannelValue, ViewType viewForUpdate) {
            this.serviceId = serviceId;
            this.contactId = contactId;
            this.contactChannelValue = contactChannelValue;
            this.viewForUpdate = viewForUpdate;
        }
